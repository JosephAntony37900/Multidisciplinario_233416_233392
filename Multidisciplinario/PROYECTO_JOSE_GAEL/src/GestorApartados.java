...
public class GestorApartados {
    ...
    public void cancelarApartado(int indice){
        ...
        System.out.println("Aplicarlo a: \n 1.- Sillas \n 2.- Mesas \n 3.-Manteles \n 4.-Carpas ");
                    ...
                    switch (elementoACambiar) {
                        ...
                        if(cantidadACambiar > inventario.productos.get(1).getCantidad() || cantidadACambiar < 0){
                            ...
                            apartadoMod.setCantidadMesas(cantidadACambiar + apartadoMod.getCantidadMesas());
                            inventario.restarCantidad("Mesas", cantidadACambiar);
                            apartadoMod.setCostoTotalCliente((cantidadACambiar*200)+apartadoMod.getCostoTotalCliente());           
                            break;
                        }
                        ...
                        if(cantidadACambiar > inventario.productos.get(2).getCantidad() || cantidadACambiar < 0){
                            ...
                            apartadoMod.setCantidadManteles(cantidadACambiar + apartadoMod.getCantidadManteles());
                            inventario.restarCantidad("Manteles", cantidadACambiar);
                            apartadoMod.setCostoTotalCliente((cantidadACambiar*11)+apartadoMod.getCostoTotalCliente());          
                            break;
                        }
    ...
    public void seguimientoApartados(){ 
        for (Integer idApartado: apartados.keySet()) {
            ...
            System.out.println("  Fecha de entrega o ya entregado: " + apartado.getFechaDeEntrega());
