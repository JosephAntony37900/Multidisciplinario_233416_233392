...
public class Cliente {
    ...
    public Cliente(String nombre, String contacto, String direccion, String correoElectronico) {
        this.nombre = nombre;
    ...
    public void registrarCliente(){
           ...
           // instancia de un objeto y asignacinn de referencia, asi se le conoce a esto ya que implementa una instancia nueva dentro del proceso de aguardar el cliente
        ...
        // cambiar el ArrayList de las rentas y ponerlo como el map del cliente, la misma logica con el id sumando en cada ciclo para que sea mas sencillo, o cambiar el map a ArrayList como en gestorRenta para tener los mismo ID, para en la busque sea mas sencillo todooo
    }
    ...
    public void consultarCliente(int idConsulta, GestorRentas gestorRentas, GestorApartados gestorApartados) {
        if (!clientes.isEmpty() && idConsulta >= 1 && idConsulta <= clientes.size()) {
            ...
            //no se que intentaste porque dice que getRentas() no existe dentro gestorRentas
            ...
            if (!gestorApartados.getApartados().isEmpty() && gestorApartados.getApartados().containsKey(idConsulta)) {
                ...
                // System.out.println("  Costo Total De La Renta: " + apartado.getCostoTotalCliente() + "$");
                System.out.println("-----------------");
            }
        } else {
